...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
                    ...
                    case "Datos técnicos":
                        ...
                        foreach ($item['campos'] as $campo) {
                            ...
                            if (in_array($idCampo, array(151, 193))) {
                                ...
                                echo "Titulo/Nombre: $valorCampo<br>";
                                $titulo = $valorCampo;
                            } elseif (in_array($idCampo, array(195))) {
                                echo "Fecha de realización: $valorCampo<br>";
                                $fechaReali = $valorCampo;
                            } elseif (in_array($idCampo, array(159, 208, 591))) {
                                echo "Estilo o tendencia: $valorCampo<br>";
                                $estiloTendencia = $valorCampo;
                            }
                        }
                        break;
        ...
        if (empty($fechaReali)) {
            ...
            echo "Fecha de realizacion: " . $fechaReali;
        }
        echo "<br>";

        if (empty($estiloTendencia)) {
            $estiloTendencia = 0;
            echo $estiloTendencia;
        } else {
            echo "Estilo o tendencia: " . $estiloTendencia;
        }
        echo "<br>";
        ...
        '$rutaImg', '$autor', '0', '$fechaReali', '$estiloTendencia', '0', '0', '0', 
        '0', '0', '0', '0', '0', '0', 
