                    ...
                    case "Tipo de objeto":
                        ...
                        foreach ($item['campos'] as $campo) {
                            ...
                            if (in_array($idCampo, array(11, 85, 251, 287, 321, 351, 383, 411, 437))) {
                                ...
                                echo "Tipo de fosil: $valorCampo<br>";
                                $tipoFosil = $valorCampo;
                            } elseif (in_array($idCampo, array(353, 385))) {
                                echo "Era geografica: $valorCampo<br>";
                                $eraGeo = $valorCampo;
                            }
                        }
                        break;
