...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
                ...
                switch ($nombreSeccion) {
                    ...
                    case "Tipo de objeto":
                        ...
                        foreach ($item['campos'] as $campo) {
                            ...
                            // Verificar el idCampo
                            if (in_array($idCampo, array(294))) {
                                echo "Proceso de manufactura: : $valorCampo<br>";
                                $procesoManufactura = $valorCampo;
                            } elseif (in_array($idCampo, array(254, 290))) {
                                echo "Material: $valorCampo<br>";
                                $material = $valorCampo;
                            } elseif (in_array($idCampo, array(210, 299))) {
                                echo "Epoca: $valorCampo<br>";
                                $epoca = $valorCampo;
                            }
                        }
                        break;
        ...
        if (empty($procesoManufactura)) {
            $procesoManufactura = 0;
            echo $procesoManufactura;
        } else {
            echo "Proceso de manufactura: " . $procesoManufactura;
        }
        echo "<br>";
        ...
        VALUES 
        ('$id', '$coleccion', '$tematica', '$titulo', '$descPieza', '$procesoManufactura', '0', 
        '$rutaImg', '0', '0', '0', '0', '0', '$epoca', '0', 
        '0', '0', '0', '0', '0', '0', 
        '$material', '$alto', '$largo', '$ancho', '$espesor', '$fondo', '$peso', '$diametro')
        ";
