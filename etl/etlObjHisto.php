...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
                ...
                switch ($nombreSeccion) {
                    ...
                    case "Características del objeto":
                        ...
                        foreach ($item['campos'] as $campo) {
                            ...
                            } elseif (in_array($idCampo, array(445))) {
                                echo "Detalles de accesorio: $valorCampo<br>";
                                $detallesAccesorio = $valorCampo;
                            } elseif (in_array($idCampo, array(25, 28, 31, 34, 37, 39, 54, 55, 86, 137, 139, 143, 448, 720, 723))) {
                                echo "Materia prima: $valorCampo<br>";
                                $materiaPrima = $valorCampo;
                            }
                        }
                        break;
        ...
        if (empty($detallesAccesorio)) {
            $detallesAccesorio = 0;
            echo $detallesAccesorio;
        } else {
            echo "Detalles de accesorio: " . $detallesAccesorio;
        }
        echo "<br>";
        ...
        if (empty($materiaPrima)) {
            ...
            echo "Materia prima: " . $materiaPrima;
        }
        echo "<br>";
        ...
        '0', '0', '0', '0', '0', '$detallesAccesorio', 
        '$materiaPrima', '$alto', '$largo', '$ancho', '$espesor', '$fondo', '$peso', '$diametro')
        ";
